            ...
            @method('put')
                <div class="row mb-3">
                    <div class="col-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="nome" style="text-transform: uppercase;" value="{{$setor->nome}}">
                    </div>
                    <div class="col-3 mb-3">
                        <label for="sigla" class="form-label">Sigla <span style="color: red"> *</span></label>
                        <input type="text" name="sigla" class="form-control" style="text-transform: uppercase;" value="{{$setor->sigla}}">
                    </div>
                </div>
